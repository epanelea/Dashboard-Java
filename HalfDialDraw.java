...
public class HalfDialDraw extends AbstractUIElement  {
     ...
     */
    public static final float DIAL_EXTENT_DEGREES = 180;

    /**
     * Where the dial starts being draw from. Due north is 90.
     */
    public static final float DIAL_START_OFFSET_DEGREES = 0;
    ...
    public HalfDialDraw() {
        ...
        setBackground(Color.BLACK);
               try {                
          image = ImageIO.read(new File("images/half4.png"));
     ...
     */
    public HalfDialDraw(int radius, int padding, int dialMaxValue, int value) {
    ...
    public void paintComponent(Graphics g) {
        ...
        //draw the half dial itself
        g.drawImage(image, 0, 0, null); 
       
        // draw the hand to indicate the current value
        g2.setColor(Color.red);
        double angle = Math.toRadians(180 - (value * (DIAL_EXTENT_DEGREES / dialMaxValue)));
