...
public class BarDrawPanel extends AbstractUIElement {
    ...
    public void paintComponent(Graphics g) {
        ...
        Color bluesh = new Color(89,183,245);
        g.setColor(bluesh);
        ...
        GradientPaint redtoblue = new GradientPaint(0 + (float) barx.getWidth() * 0.1F, 0, Color.RED, (float) barx.getWidth() * 0.3F, 0, bluesh);
